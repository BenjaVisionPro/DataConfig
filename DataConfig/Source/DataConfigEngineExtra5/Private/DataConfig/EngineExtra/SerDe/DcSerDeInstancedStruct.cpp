...
DC_TEST("DataConfig.EngineExtra.SerDe.InstancedStruct")
{
	using namespace DcExtra;
	FDcEngineExtra5InstancedStruct1 Dest;
...
DC_TEST("DataConfig.EngineExtra.SerDe.InstancedStructBaseStruct")
{
	using namespace DcExtra;
	FDcEngineExtra5InstancedStruct2 Dest;
	FDcPropertyDatum DestDatum(&Dest);
